...
struct Qwen35Model::Impl {
    ...
    // Batched-prefill tile scratch (lazy-grown to SPARKINFER_PREFILL_TILE_ROWS).
    int pf_tile_cap = 0;
    int* pf_toks = nullptr;
    int* pf_pos = nullptr;
    ...
    float* pf_mf_out = nullptr;
    int* pf_mf_ids = nullptr;
    float* pf_mf_weights = nullptr;
...
Qwen35Model::~Qwen35Model() {
    ...
    cudaFree(p_->pf_mf_out); cudaFree(p_->pf_mf_ids); cudaFree(p_->pf_mf_weights);
